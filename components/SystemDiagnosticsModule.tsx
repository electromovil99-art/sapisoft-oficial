...
const SystemDiagnosticsModule: React.FC<SystemDiagnosticsProps> = ({ 
    ...
    const runTraceabilityTest = async () => {
        ...
        try {
            ...
            onProcessSale(saleCart1, 300.00, 'TICKET DE VENTA', 'CLIENTE ALPHA', { cash: 300, yape: 0, card: 0, bank: 0 }, saleId1, [{ method: 'Efectivo', amount: 300 }], 'PEN', 1);
            ...
            onProcessSale(saleCart2, 600.00, 'TICKET DE VENTA', 'CLIENTE BETA', { cash: 600, yape: 0, card: 0, bank: 0 }, saleId2, [{ method: 'Efectivo', amount: 600 }], 'PEN', 1);
            ...
            onProcessCreditNote(saleId1, returnItems, 200.00, { cash: 200, yape: 0, card: 0, bank: 0 }, [{ method: 'Efectivo', amount: 200 }]);
